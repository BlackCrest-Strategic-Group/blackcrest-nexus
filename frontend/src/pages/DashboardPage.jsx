...
export default function DashboardPage() {
  ...
  return <section>
    ...
    <div className='grid three' style={{marginTop:'1rem'}}>
      <article className='card'><h3>Cost Savings</h3><p>${analysis.summary.totalSavingsOpportunity.toLocaleString()}</p></article>
      <article className='card'><h3>Alerts</h3><p>{analysis.riskFlags.length}</p></article>
      <article className='card'><h3>Supplier Performance</h3><p>{analysis.supplierPerformance.length} suppliers scored</p></article>
    </div>
