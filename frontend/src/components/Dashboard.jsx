...
function NonClassifiedTab({ analysisResult }) {
  if (!analysisResult) {
    return (
      <div className="space-y-4 animate-fade-in">
        <div className="card text-center py-16">
          ...
          <p className="text-slate-600 font-semibold">No document analyzed yet</p>
          <p className="text-slate-400 text-sm mt-1">Upload a solicitation document in the Analyze tab to run the Non-Classified Use Verification</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#f7fafe" }}>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6">
        ...
        {/* ── Non-Classified ── */}
        {tab === "nonclass" && <NonClassifiedTab analysisResult={analysisResult} />}
